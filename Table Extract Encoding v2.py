...
dfs = tabula.read_pdf(pdf_path, pages='3', encoding='utf-8', lattice=True)
...
if not dfs:
    ...
    dfs[0].to_csv('first_table.csv', index=False, encoding='utf-8')
